                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <i class="fa fa-plus"></i> <h3 class="box-title">Agregar Detalle Al Control de Calidad</h3>
                                    <div class="box-tools">
                                        <a href="calidad_index.php" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i></a>
                                    </div>
                                </div>
                                <div class="box-body">
                                ...
                                <?php }?>                                    
                                    <?php $compra = consultas::get_datos("select * from v_cont_calidad where cont_calid_cod = ".$_REQUEST['vcont_calid_cod']);?>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="table-responsive">
                                                <table class="table table-striped table-condensed table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td data-title="#"><?php echo $com['cont_calid_cod'];?></td>
                                                            <td data-title="Fecha"><?php echo $com['fecha'];?></td>
                                                            <td data-title="Estado"><?php echo $com['estado_calidad'];?></td>
                                    ...
                                    <?php $compradet = consultas::get_datos("select * from v_detalle_cont_calidad where cont_calid_cod = ".$_REQUEST['vcont_calid_cod']);?>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                                            
                                            <?php if (!empty($compradet)) {?>
                                            <div class="box-header">
                                                <i class="fa fa-list"></i><h3 class="box-title">Detalle Control Calidad</h3>                                        
                                            </div>                                            
                                            <div class="table-responsive">
                                                <table class="table table-striped table-condensed table-hover">
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>Artiulo</th>
                                                            <th>Cantidad</th>
                                                              <?php if ($det['calidad1'] == 't' or $det['calidad2'] == 't' or $det['calidad3']== 't' ) {?>
                                                            <th>Calidad 1</th>
                                                            <th>Calidad 2</th>
                                                            <th>Calidad 3</th>
                                                            <th>OBS:</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td data-title="#"><?php echo $det['cont_calid_cod'];?></td>
                                                            <td data-title="Articulo"><?php echo $det['art_descri'];?></td>
                                                            <td data-title="cantidad"><?php echo $det['cant'];?></td>
                                                            <?php if ($det['calidad1'] == 't' or $det['calidad2'] == 't' or $det['calidad3']== 't' ) {?>
                                                            <td > <input  type="checkbox"<?php if ($det['calidad1']== 't') {?>checked <?php }else{ }?> disabled=""> <?php echo $det['det1']?></td>
                                                        <td> <input type="checkbox" <?php if ($det['calidad2']== 't') {?>checked <?php }else{ }?>disabled=""><?php echo $det['det2']?></td>
                                                        <td> <input type="checkbox" <?php if ($det['calidad3']== 't') {?>checked <?php }else{ }?>disabled="" >  <?php echo $det['det3']?></td>
                                                        <td data-title="OBS:"><?php echo $det['detall'];?></td>
                                                     <?php  } else if (!empty($det['detall'])) {?>
                                                        <td data-title="OBS:"><?php echo $det['detall'];?></td>
                                                        <?php }else { }?>
                                                            <td data-title="Acciones" class="text-center">
                                                                <a onclick="editar(<?php echo $det['cont_calid_cod']?>,<?php echo $det['art_cod']?>)" class="btn btn-success btn-sm" 
                                                                   data-title="Detalle" rel="tooltip" data-toggle="modal" data-target="#editar">
                                                                    <i class="glyphicon glyphicon-list"></i> </a>
                                                               
                                                                    <a onclick="borrar(<?php echo "'".$det['cont_calid_cod']."_".$det['art_cod'].$det['art_descri']."'"?>)" class="btn btn-danger btn-sm" data-title="Borrar" rel="tooltip" 
...
<!--                                            <div class="row">
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <input type="hidden" name="vcont_calid_cod" value="<?php// echo $compra[0]['cont_calid_cod'];?>"> 
...
<!--                                    <div class="row">
                                            ...
                                            <form action="calidad_dcontrol.php" method="POST" accept-charset="utf-8" class="form-horizontal">
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                     ...
                                                     <div class="form-group">
                                                        <label class="control-label col-lg-2 col-md-2 col-sm-2">Calidad 1:</label>
                                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                                                <?php// $articulos = consultas::get_datos("select * from calidads_producc where tip_art_cod =".$det['tip_art_cod']);?>
                                                            <select class="form-control select2" name="vetap_pruducc_cod" required="" id="calidad" onchange="etap()">
                                                                    <?php// if (!empty($articulos)) {                                                         
                                                                    //foreach ($articulos as $articulo) { ?>
        ...
        function borrar(datos){
         ...
         function editar(ped,art){
            $.ajax({
                type    : "GET",
                url     : "/allcant.2.0/calidad_dedit.php?vcont_calid_cod="+ped+"&vart_cod="+art,
                cache   : false,
                beforeSend:function(){
