            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="box-header">
                            ...
                            <h3 class="box-title">Informe de Cliente</h3>
                            <div class="box-tools">
                                  ...
                                  <form action='cliente_print.php' method="GET" accept-charset="UTF-8" class="form-horizontal">
                                      ...
                                      <div class="col-lg-4 col-md-4 col-xs-4" >
                                          <div class="panel panel-primary">
                                              ...
                                              <div class="panel-body">
                                                  <div class="list-group">
                                                      ...
                                                      <a href="cliente_rpt.php?opcion=2" class="list-group-item">Por C.I</a>
                                                        <a href="cliente_rpt.php?opcion=3" class="list-group-item">Por Nombres</a>
                                          ...
                                          <div class="panel panel-primary">
                                              ...
                                              <div class="panel-body">
                                                <?php if ($opcion==1){
                                                       $cli = consultas::get_datos('select * from v_clientes order by cli_cod'); 
                                                  }else if($opcion==2) {
                                                       $cli = consultas::get_datos('select * from v_clientes order by cli_ci');
                                                  } else {
                                                      $cli = consultas::get_datos('select * from v_clientes order by clientes ');
                                                      } ?>
