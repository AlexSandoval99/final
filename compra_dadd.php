...
$detalles = consultas::get_datos("select * from v_detalle_ordcompra where ord_com=".$_REQUEST['vord_com']
...
<div class="modal-header">
    ...
    <h4 class="modal-title"><i class="fa fa-plus"></i> Agregar Detalle de Compra</h4>
</div>
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-2 col-md-2 col-sm-2">
                <input type="number" class="form-control" name="vcom_cant" min="1" value="<?php echo $detalles[0]['ord_cant'];?>"/>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-lg-2 col-md-2 col-sm-2">Precio:</label>
            <div class="col-lg-4 col-md-4 col-sm-4">
                <input type="number" class="form-control" name="vcom_precio" min="1" value="<?php echo $detalles[0]['ord_precio'];?>"/>
            </div>
        </div> 
    </div>
