...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools">
                                        <a href="compra_index.php" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i></a>
                                    </div>
                                </div>
                                <div class="box-body">
                                ...
                                <?php }?>                                    
                                    ...
                                    <?php $ordendet = consultas::get_datos("select * from v_detalle_ordcompra where ord_com = ".$compra[0]['ord_com']
                                            ." and art_cod not in(select art_cod from detalle_compra where com_cod =".$compra[0]['com_cod'].")");?>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                                            
                                    ...
                                    <?php $compradet = consultas::get_datos("select * from v_detalle_compra where com_cod = ".$compra[0]['com_cod']);?>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                                            
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <form action="compra_dcontrol.php" method="POST" accept-charset="utf-8" class="form-horizontal">
                                                <div class="box-body">
        ...
        function editar(com,art,dep){
            $.ajax({
                type    : "GET",
                url     : "/taller/compra_dedit.php?vcom_cod="+com+"&vart_cod="+art+"&vdep_cod="+dep,
                cache   : false,
                beforeSend:function(){
        ...
        function add(ord,art,dep,com){
            ...
            $.ajax({
                type    : "GET",
                url     : "/taller/compra_dadd.php?vord_com="+ord+"&vart_cod="+art+"&vdep_cod="+dep+"&vcom_cod="+com,
                cache   : false,
                beforeSend:function(){
                    $("#detalles").html('<strong>Cargando...</strong>')
                },
