                                                    ...
                                                    <div class="col-sm-8 col-lg-8">
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">                                                                
                                                                ...
                                                                <?php       break;
                                                                            case 2: 
                                                                                $proveedor = consultas::get_datos("select * from proveedor where prv_cod in(select prv_cod from compras)");
                                                                            ?> 
                                                                            <div class="form-group">
                                                                                <label class="control-label col-lg-2 col-md-2">Proveedor:</label>
                                                                                <div class="col-lg-6 col-md-6">
                                                                                    <select class="form-control select2" name="vprv_razonsocial">
