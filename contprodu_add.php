 ...
 <!--contenedor principal-->
            <div class="content">
                <div class="row">
                    ...
                    <div class="box-header">
                            ...
                            <h3 class="box-title">Agregar Control de Produccion</h3>
                            <div class="box-tools">
                                <a href="contprodu_index.php" class="btn btn-primary btn-sm pull-right" data-title="Volver" rel="tooltip" 
                                           data-placement="top">
                        ...
                        <?php } ?> 
                           <!--buscador-->
                           <form action="contprodu_control.php" method="POST" accept_charset="utf-8" class="from-horizontal">
                               <input type="hidden" name="accion" value="1">
                               <input type="hidden" name="vcont_producc_cod" value="0">
                               <div class="box-body">
                                   <div class="row">
                                <div class="col-lg-4 col-sm-4 col-md-4 col-xs-6">
                                     <?php $fecha= consultas::get_datos("select current_date as fecha"); ?>
                                    <label>Fecha:</label>
                                    <input type="date" name="vproduc_fecha" class="form-control" required="" value="<?php echo $fecha[0]['fecha']; ?>" readonly="">
                            </div>
                                       <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                                     <label>Clientes:</label>
                                     <div class="input-group">
                                      <?php $proveedor = consultas::get_datos("select * from clientes order by cli_cod");?>
                                                    <select class="form-control select2" name="vcli_cod" required=""  id="ord" onchange="orden()">
                                                       ...
                                                       <?php  foreach ($proveedor as $prov) { ?>
                                                        ...
                                                        <option value="">Debe insertar al menos una Orden</option>
                                                        <?php }?>
                                                    </select>
        ...
        $("#mensaje").delay(4000).slideUp(200, function (){
         ...
         function orden(){
                ...
                $.ajax({
                   type  : "GET",
                   url   : "/allcant.2.0/contprodu.php?vcli_cod="+$('#ord').val(),
                   cache : false,
                   beforeSend:function(){
