                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <form action="ordcompras_print.php" method="GET" accept-charset="utf-8" class="form-horizontal">
                                                        ...
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="list-group">
                                                                    <a href="ordcompras_rpt.php?opcion=1" class="list-group-item">Por Fecha</a>
                                                                    <a href="ordcompras_rpt.php?opcion=2" class="list-group-item">Por Proveedor</a>
                                                                    <a href="ordcompras_rpt.php?opcion=3" class="list-group-item">Por Articulo</a>
                                                                    <a href="ordcompras_rpt.php?opcion=4" class="list-group-item">Por Empleado</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-8 col-lg-8">
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">                                                                
                                                                ...
                                                                <?php       break;
                                                                            case 2: 
                                                                                $proveedores = consultas::get_datos("select * from proveedor where prv_cod in(select prv_cod from orden_cabcompra)");
                                                                            ?> 
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-6 col-md-6">
                                                                                    <select class="form-control select2" name="vproveedor">
                                                                                        ...
                                                                                        <option value="<?php echo $prove['prv_cod'];?>">
                                                                                        <?php echo $prove['prv_ruc']." ".$prove['prv_razonsocial'];?></option>
                                                                                        <?php }?>
                                                                                    </select>
                                                                                </div>
                                                                            </div>                                                                
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-6 col-md-6">
                                                                                    <select class="form-control select2" name="varticulo">
                                                                                        ...
                                                                                        <option value="<?php echo $ar['art_cod'];?>">
                                                                                        <?php echo $ar['art_descri']." ".$ar['mar_descri'];?></option>
                                                                                        <?php }?>
                                                                                    </select>
                                                                                </div>
                                                                            </div>                                                                  
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-6 col-md-6">
                                                                                    <select class="form-control select2" name="vempleado">
                                                                                        ...
                                                                                        <option value="<?php echo $em['emp_cod'];?>">
                                                                                        <?php echo $em['emp_nombre']." ".$em['emp_apellido'];?></option>
                                                                                        <?php }?>
                                                                                    </select>
                                                                                </div>
                                                                            </div>                                                                 
