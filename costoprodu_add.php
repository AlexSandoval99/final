 ...
 <!--contenedor principal-->
            <div class="content">
                <div class="row">
                    ...
                    <div class="box-header">
                            ...
                            <h3 class="box-title">Agregar Costo de Produccion</h3>
                            <div class="box-tools">
                                <a href="costoprodu_index.php" class="btn btn-primary btn-sm pull-right" data-title="Volver" rel="tooltip" 
                                           data-placement="top">
                        ...
                        <?php } ?> 
                           <!--buscador-->
                           <form action="costoprodu_control.php" method="POST" accept_charset="utf-8" class="from-horizontal">
                               <input type="hidden" name="accion" value="1">
                               <input type="hidden" name="vcost_prod_cod" value="0">
                               <div class="box-body">
                                   <div class="row">
                                <div class="col-lg-4 col-sm-4 col-md-4 col-xs-6">
                                     <?php $fecha= consultas::get_datos("select current_date as fecha"); ?>
                                    <label>Fecha:</label>
                                    <input type="date" name="vfecha" class="form-control" required="" value="<?php echo $fecha[0]['fecha']; ?>" readonly="">
                            </div>
        ...
        $("#mensaje").delay(4000).slideUp(200, function (){
         ...
         function pedidos(){
                ...
                $.ajax({
                   type  : "GET",
                   url   : "/allcant.2.0/costoprodu.php?vcli_cod="+$('#proveedor').val(),
                   cache : false,
                   beforeSend:function(){
