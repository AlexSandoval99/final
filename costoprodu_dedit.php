...
$consul = consultas::get_datos("select * from v_det_cost where cost_prod_cod=".$_REQUEST['vcost_prod_cod']);
...
<div class="modal-header">
    ...
    <h4 class="modal-title"><i class="fa fa-plus"></i> Costo de Produccion</h4>
</div>
 ...
 <div class="table-responsive">
                                                <table class="table table-striped table-condensed table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <td class="text-center" data-title="Cantidad de Materia Prima"><?php $flowers = array($cons['cant']*$det['mater_precio']);                                                               
                                                                //Prints the array
