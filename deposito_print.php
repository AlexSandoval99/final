...
//COLOR DE TABLA
        ...
        if (!empty(isset($_REQUEST['vdesde'])) && !empty(isset($_REQUEST['vdesde'])) ) {
            ...
            $deposito = consultas::get_datos("select * from v_deposito where dep_descri between '".$_REQUEST['vdesde']."' and '".$_REQUEST['vhasta']."' " );
                ...
                $deposito = consultas::get_datos("select * from v_deposito where suc_descri between '".$_REQUEST['vdesde']."' and '".$_REQUEST['vhasta']."'" );
            }
              }     else{
        ...
        foreach ($deposito as $d ) {
            ...
            $pdf->Cell(50,5,$d['dep_descri'], 1, 0, 'C', 1);
            $pdf->Cell(50,5,$d['suc_descri'], 1, 0, 'L', 1);
