            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="box-header">
                            ...
                            <h3 class="box-title">Informe de Empleado</h3>
                            <div class="box-tools">
                                  ...
                                  <form action='empleado_print.php' method="GET" accept-charset="UTF-8" class="form-horizontal">
                                      ...
                                      <div class="col-lg-4 col-md-4 col-xs-4" >
                                          <div class="panel panel-primary">
                                              ...
                                              <div class="panel-body">
                                                  <div class="list-group">
                                                      ...
                                                      <a href="empleado_rpt.php?opcion=2" class="list-group-item">Por Nombre</a>
                                                      <a href="empleado_rpt.php?opcion=3" class="list-group-item">Por Cargo</a>
                                                  </div>
                                          ...
                                          <div class="panel panel-primary">
                                              ...
                                              <div class="panel-body">
                                                  <?php if ($opcion==1){
                                                       $emp = consultas::get_datos('select * from v_empleado order by emp_cod'); 
                                                  }else if($opcion==2) {
                                                       $emp = consultas::get_datos('select * from v_empleado order by empleado');
                                                  } else {
                                                      $emp = consultas::get_datos('select * from v_empleado order by car_descri ');
                                                      } ?>
