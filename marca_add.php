            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="box-header">
                            ...
                            <form action="marca_control.php" method="POST" accept_charset="utf-8" class="from-horizontal">
                                ...
                                <div class="box-body">
                                    <div class="from-group">
                                        ...
                                        <div class="col-lg-8 col-md-6">
                                            <input type="text" class="from-control"  name="vmar_descri" required="" autofocus="">
                            ...
                            <?php $mar= mysqli_escape_string($link, $_POST["vmar_descri"]) ?>
             </div>
           </div>
         </div>
            </div>
