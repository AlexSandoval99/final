                ...
                <div class="row">
                    ...
                    <div class="box-header">
                            ...
                            <div class="box-tools">
                                ...
                                <a href="marca_print.php" class="btn btn-primary pull-right btn-sm" data-title="Imprimir" rel="tooltip">
                        ...
                        <?php } ?> 
                           <!--buscador-->
                            <div class="row">
                                ...
                                <?php
                                $marca = consultas::get_datos("select * from marca where (mar_cod||mar_descri) ilike '%".(isset($_REQUEST['buscar'])?$_REQUEST['buscar']:'')."%'order by mar_cod");
                                if (!empty($marca)){ ?>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td data-title="Acciones" class="text-center">
                                                      <a onclick="editar(<?php echo "'".$mar['mar_cod']."_".$mar['mar_descri']."'"?>)" class="btn btn-warning btn-sm" role="button" data-title="Editar" 
                                                                       data-toggle="modal" data-target="#editar" rel="tooltip" data-placement="top">
                                                                        <span class="glyphicon glyphicon-edit"></span></a>
                                                        <a onclick="borrar(<?php echo "'".$mar['mar_cod']."_".$mar['mar_descri']."'"?>)" class="btn btn-danger btn-sm" role="button" data-title="Borrar" 
                          ...
                          <div class = "modal-content">
                              <div class = "modal-header">
                                  <button class = "close" data-dispats = "modal" aria-label = "Cerrar">
                                      ...
                                      <h4 class = "modal-title"> <i class = "fa fa-plus"> </i> Registrador Marcas </h4>
                              </div>
                      ...
                      <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <form action="marca_control.php" method="POST" accept-charset="utf-8" class="form-horizontal">
                                  ...
                                  <input type="hidden" name="vmar_cod" id="cod">
                                  <div class="modal-body">
                                      <div class="form-group">
                                          <label class="control-label col-lg-2 col-sm-2">Descripción</label>
                                          <div class="col-lg-10 col-sm-10">
                                              <input type="text" name="vmar_descri" class="form-control" required="" autofocus="" id="descri"/>
                                          </div>
                                      </div>
                                  </div>
                                  <div class="modal-footer">
