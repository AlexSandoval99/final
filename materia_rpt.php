                                  ...
                                  <form action='marca_print.php' method="GET" accept-charset="UTF-8" class="form-horizontal">
                                      ...
                                      <div class="col-lg-4 col-md-4 col-xs-4" >
                                          <div class="panel panel-primary">
                                              ...
                                              <div class="panel-body">
                                                  <div class="list-group">
                                                      ...
                                                      <a href="marca_rpt.php?opcion=2" class="list-group-item">Por Descripcion</a>
                                          ...
                                          <div class="panel panel-primary">
                                              ...
                                              <div class="panel-body">
                                                  <?php if ($opcion==1){
                                                       $marca = consultas::get_datos('select * from marca order by mar_cod'); 
                                                  }else{
                                                       $marca = consultas::get_datos('select * from marca order by mar_descri');
                                                  } ?>
                                                      ...
                                                      <div class="col-lg-6 col-md-6 col-xs-6" > 
                                                          <select class="form-control select2" name="vdesde">
                                                           <?php foreach ($marca as $m) { ?>
                                                              <option value="<?php echo ($opcion==1)?$m['mar_cod']:$m['mar_descri']; ?>">
                                                                 
                                                                    <?php echo($opcion==1)?$m['mar_cod']:$m['mar_descri'];?></option>   
                                                              <?php }?>
