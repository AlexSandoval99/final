...
<form action="ordcompra_dcontrol.php" method="POST" accept-charset="utf-8" class="form-horizontal">
    ...
    <input type="hidden" name="vord_com" value="<?php echo $detalles[0]['ord_com'];?>">
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-2 col-md-2 col-sm-2">
                <input type="number" class="form-control" name="vord_cant" min="1" value="<?php echo $detalles[0]['ord_cant'];?>"/>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-lg-2 col-md-2 col-sm-2">Precio:</label>
            <div class="col-lg-4 col-md-4 col-sm-4">
                <input type="number" class="form-control" name="vord_precio" min="1" value="<?php echo $detalles[0]['ord_precio'];?>"/>
            </div>
        </div> 
    </div>
