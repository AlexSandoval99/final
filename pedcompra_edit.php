            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="box-header">
                        ...
                        <?php } ?> 
                           <!--buscador-->
                           <form action="pedcompra_control.php" method="POST" accept_charset="utf-8" class="from-horizontal">
                               <?php $compras = consultas::get_datos("select * from v_pedido_cabcompra where ped_com =".$_REQUEST['vped_com'] ); ?>
                               <input type="hidden" name="accion" value="2">
                               <input type="hidden" name="vped_com" value="<?php echo $compras[0]['ped_com']; ?>">
                               <div class="box-body">
                                   <div class="row">
                                <div class="col-lg-4 col-sm-4 col-md-4 col-xs-6">
                                    <label>Fecha:</label>
                                    <input type="text" name="vped_fecha" class="form-control" required="" value="<?php echo $compras[0]['ped_fecha'];?> " readonly="">
                            </div>
