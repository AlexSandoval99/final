    ...
    <body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools">
                                        <a href="pedmater_index.php" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i></a>
                                    </div>
                                </div>
                                <div class="box-body">
                                ...
                                <?php }?>                                    
                                    <?php $pedidos = consultas::get_datos("select * from v_pedido_mater where pedm_cod = ".$_REQUEST['vpedm_cod']);?>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <?php $pedidosdet = consultas::get_datos("select * from v_det_pedmat where pedm_cod = ".$_REQUEST['vpedm_cod']);?>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                                            
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-condensed table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td data-title="#"><?php echo $det['pedm_cod'];?></td>
                                                            <td data-title="Descripción"><?php echo $det['mater_descri'];?></td>
                                                            <td data-title="Cantidad"><?php echo $det['det_cant'];?></td>
                                                            <td data-title="Acciones" class="text-center">
                                                                <a onclick="editar(<?php echo $det['pedm_cod']?>,<?php echo $det['mater_cod']?>,<?php echo $det['dep_cod']?>)" class="btn btn-warning btn-sm" 
                                                                   data-title="Editar" rel="tooltip" data-toggle="modal" data-target="#editar">
                                                                    <i class="fa fa-edit"></i></a>
                                                                    <a onclick="borrar(<?php echo "'".$det['pedm_cod']."_".$det['mater_cod']."_".$det['dep_cod']."_".$det['mater_descri']."'"?>)" class="btn btn-danger btn-sm" data-title="Borrar" rel="tooltip" 
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <form action="pedmater_dcontrol.php" method="POST" accept-charset="utf-8" class="form-horizontal">
                                                <div class="box-body">
                                                    ...
                                                    <input type="hidden" name="vpedm_cod" value="<?php echo $pedidos[0]['pedm_cod'];?>">
                                                      
                                                    <div class="form-group">
                                                        <label class="control-label col-lg-2 col-md-2 col-sm-2">Materia Prima:</label>
                                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                                                <?php $materias = consultas::get_datos("select * from mater_prim order by mater_descri");?>
                                                            <select class="form-control select2" name="vmater_cod" required=""  >
                                                                    ...
                                                                    <option value="">Debe insertar al menos una Materia</option>
                                                                    <?php }?>
                                                                </select> 
                                                        </div>
                                                    </div> 
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-sm-2">
                                                            <input type="number" class="form-control" name="vdet_cant" min="1" value="1"/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
        ...
        function borrar(datos){
            var dat = datos.split('_');
                $('#si').attr('href','pedmater_dcontrol.php?vpedm_cod='+dat[0]+'&vmater_cod='+dat[1]+'&vdep_cod='+dat[2]+'&accion=3');
                $('#confirmacion').html('<span class="glyphicon glyphicon-question-sign"></span> \n\
                Desea quitar la materia <strong>'+dat[3]+'</strong> del pedido N° <strong>'+dat[0]+'</strong>?');
        }
        function editar(ped,art,dep){
            $.ajax({
                type    : "GET",
                url     : "/allcant.2.0/pedmater_dedit.php?vpedm_cod="+ped+"&vmater_cod="+art+"&vdep_cod="+dep,
                cache   : false,
                beforeSend:function(){
