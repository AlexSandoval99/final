                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <form action="pedcompras_print.php" method="GET" accept-charset="utf-8" class="form-horizontal">
                                                        ...
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="list-group">
                                                                    <a href="pedcompras_rpt.php?opcion=1" class="list-group-item">Por Fecha</a>
                                                    ...
                                                    <div class="col-sm-8 col-lg-8">
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">                                                                
                                                                ...
                                                                <?php       break;
                                                                            case 2: 
                                                                                $proveedores = consultas::get_datos("select * from proveedor where prv_cod in(select prv_cod from pedido_cabcompra)");
                                                                            ?> 
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-6 col-md-6">
                                                                                    <select class="form-control select2" name="vproveedor">
                                                                                        ...
                                                                                        <option value="<?php echo $prov['prv_cod'];?>">
                                                                                        <?php echo $prov['prv_ruc']." ".$prov['prv_razonsocial'];?></option>
                                                                                        <?php }?>
                                                                                    </select>
                                                                                </div>
                                                                            </div>                                                                
