                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <form action="pedventa_print.php" method="GET" accept-charset="utf-8" class="form-horizontal">
                                                        ...
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="list-group">
                                                                    <a href="pedventa_rpt.php?opcion=1" class="list-group-item">Por Fecha</a>
                                                                    <a href="pedventa_rpt.php?opcion=2" class="list-group-item">Por Cliente</a>
                                                                    <a href="pedventa_rpt.php?opcion=3" class="list-group-item">Por Articulo</a>
                                                                    <a href="pedventa_rpt.php?opcion=4" class="list-group-item">Por Empleado</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
