                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools">
                                        <a href="pedventa_add.php" class="btn btn-primary btn-sm" data-title = "Agregar" 
                                        ...
                                        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                            ...
                                            <?php
                                               /* $valor ='';
                                                ...
                                                $pedidos = consultas::get_datos("select * from v_pedido_cabventa where id_sucursal =".$_SESSION['id_sucursal']." and"
                                                        . "(ped_cod||clientes) ilike '%".(isset($_REQUEST['buscar'])? $_REQUEST['buscar']:'')."%' order by ped_cod desc limit 5");
                                                if (!empty($pedidos)) { ?>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td data-title="Acciones" class="text-center">
                                                                    ...
                                                                    <a href="pedventas_det.php?vped_cod=<?php echo $pedido['ped_cod'];?>" class="btn btn-success btn-sm" role="button" data-title="Detalles" 
                                                                       rel="tooltip" data-placement="top">
                                                                        <span class="glyphicon glyphicon-list"></span></a>
                                                                    <a href="pedventa_edit.php?vped_cod=<?php echo $pedido['ped_cod'];?>" class="btn btn-warning btn-sm" role="button" data-title="Editar" 
                                                                       rel="tooltip" data-placement="top">
                                                                        <span class="glyphicon glyphicon-edit"></span></a>
                                                                        <a onclick="anular(<?php echo "'".$pedido['ped_cod']."_".$pedido['clientes']."'"?>)"  class="btn btn-danger btn-sm" role="button" data-title="Anular" rel="tooltip" data-placement="top" 
                                                                        data-toggle="modal" data-target="#anular">
                                                                        <span class="glyphicon glyphicon-remove"></span></a>  
                                                                    <?php }?>
                                                                    <a href="pedventa_print.php?vped_cod=<?php echo $pedido['ped_cod'];?>" class="btn btn-primary btn-sm" role="button" data-title="Imprimir" 
                                                                       rel="tooltip" data-placement="top">
