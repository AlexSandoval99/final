 ...
 <!--contenedor principal-->
            <div class="content">
                <div class="row">
                    ...
                    <div class="box-header">
                            ...
                            <div class="box-tools">
                                <a href="presuprodu_index.php" class="btn btn-primary btn-sm pull-right" data-title="Volver" rel="tooltip" 
                                           data-placement="top">
                        ...
                        <?php } ?> 
                           <!--buscador-->
                           <form action="presuprodu_control.php" method="POST" accept_charset="utf-8" class="from-horizontal">
                               <input type="hidden" name="accion" value="1">
                               <input type="hidden" name="vpresuprod_cod" value="0">
                               <div class="box-body">
                                   <div class="row">
                                <div class="col-lg-4 col-sm-4 col-md-4 col-xs-6">
                                     <?php $fecha= consultas::get_datos("select current_date as fecha"); ?>
                                    <label>Fecha:</label>
                                    <input type="date" name="vfech_pres" class="form-control" required="" value="<?php echo $fecha[0]['fecha']; ?>" readonly="">
                            </div>
                                       <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                                     <label>Cliente:</label>
                                     <div class="input-group">
                                      <?php $proveedor = consultas::get_datos("select * from clientes order by cli_cod");?>
                                                    <select class="form-control select2" name="vcli_cod" required=""  id="pre" onchange="presupuesto()">
        ...
        $("#mensaje").delay(4000).slideUp(200, function (){
         ...
         function presupuesto(){
                ...
                $.ajax({
                   type  : "GET",
                   url   : "/allcant.2.0/presuprodu.php?vcli_cod="+$('#pre').val(),
                   cache : false,
                   beforeSend:function(){
