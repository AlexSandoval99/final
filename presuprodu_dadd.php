...
$detalles = consultas::get_datos("select * from v_detalle_ped_produc where pro_cod=".$_REQUEST['vpro_cod']
...
<form action="presuprodu_dcontrol" method="POST" accept-charset="utf-8" class="form-horizontal">
    <input type="hidden" name="accion" value="1">
    <input type="hidden" name="vpresuprod_cod" value="<?php echo $_REQUEST['vpresuprod_cod'];?>">
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-2 col-md-2 col-sm-2">
                <input type="number" class="form-control" name="vpresup_cant" min="1" value="<?php echo $detalles[0]['ped_cant'];?>"/>
            </div>
        </div>
        <input type="hidden" name="vprecio_presu" value="<?php echo $detalles[0]['ped_precio'];?>" />
    </div>
