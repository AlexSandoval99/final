...
<div class="modal-header">
    ...
    <h4 class="modal-title"><i class="fa fa-plus"></i> Editar Detalle de Venta</h4>
</div>
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-2 col-md-2 col-sm-2">
                <input type="number" class="form-control" name="vven_cant" min="1" value="<?php echo $detalles[0]['ven_cant'];?>"/>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-lg-2 col-md-2 col-sm-2">Precio:</label>
            <div class="col-lg-4 col-md-4 col-sm-4">
                <input type="number" class="form-control" name="vven_precio" min="1" value="<?php echo $detalles[0]['ven_precio'];?>"/>
            </div>
        </div> 
    </div>
