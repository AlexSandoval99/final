    ...
    <body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <i class="fa fa-plus"></i> <h3 class="box-title">Agregar Detalle Ventas</h3>
                                    <div class="box-tools">
                                        <a href="ventas_index.php" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i></a>
                                    </div>
                                </div>
                                <div class="box-body">
                                ...
                                <?php }?>                                    
                                                ...
                                                <table class="table table-striped table-condensed table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td data-title="Total"><?php echo $venta['ven_total'];?></td>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                                            
                                            ...
                                            <div class="box-header">
                                                <i class="fa fa-list"></i><h3 class="box-title">Detalle Items del Pedido N°<?php echo $pedidosdet[0]['ped_cod'];?></h3>                                        
                                            </div>                                            
                                            <div class="table-responsive">
                                                <table class="table table-striped table-condensed table-hover">
                                                    <thead>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td data-title="#"><?php echo $detp['ped_cod'];?></td>
                                                            <td data-title="Descripción"><?php echo $detp['art_descri']." ".$detp['mar_descri'];?></td>
                                                            <td data-title="Cantidad"><?php echo $detp['ped_cant'];?></td>
                                                            <td data-title="Precio"><?php echo number_format($detp['ped_precio'],0,",",".");?></td>
                                                            <td data-title="Impuesto"><?php echo $detp['tipo_descri'];?></td>
                                                            <td data-title="Precio"><?php echo number_format($detp['subtotal'],0,",",".");?></td>
                                                            <td data-title="Acciones">
                                                                <a onclick="add(<?php echo $detp['ped_cod'];?>,<?php echo $detp['art_cod'];?>,<?php echo $detp['dep_cod'];?>,<?php echo $ventas[0]['ven_cod'];?>)" class="btn btn-success btn-sm" 
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                                            
                                            <?php if (!empty($ventasdet)) {?>
                                            <div class="box-header">
                                                <i class="fa fa-list"></i><h3 class="box-title">Detalle Ventas Items</h3>                                        
                                            </div>                                            
                                            <div class="table-responsive">
                                                <table class="table table-striped table-condensed table-hover">
                                                    <thead>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td data-title="#"><?php echo $det['ven_cod'];?></td>
                                                            ...
                                                            <td data-title="Acciones">
                                                                <a onclick="editar(<?php echo $det['ven_cod']?>,<?php echo $det['art_cod']?>,<?php echo $det['dep_cod']?>)" class="btn btn-warning btn-sm" 
                                                                   data-title="Editar" rel="tooltip" data-toggle="modal" data-target="#editar">
                                                                    <i class="fa fa-edit"></i></a>
                                                                    <a onclick="borrar(<?php echo "'".$det['ven_cod']."_".$det['art_cod']."_".$det['dep_cod']."_".$det['art_descri']."'"?>)" class="btn btn-danger btn-sm" data-title="Borrar" rel="tooltip" 
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-sm-2">
                                                            <input type="number" class="form-control" name="vven_cant" min="1" value="1"/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-lg-2 col-md-2 col-sm-2">Precio:</label>
                                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                                            <input type="number" class="form-control" name="vven_precio" min="1" value="1" id="vprecio"/>
                                                        </div>
                                                    </div>                                                    
                                                </div>
        ...
        function borrar(datos){
            var dat = datos.split('_');
                ...
                Desea quitar el articulo <strong>'+dat[3]+'</strong> de la venta N° <strong>'+dat[0]+'</strong>?');
        }
        function editar(ven,art,dep){
            $.ajax({
                type    : "GET",
                url     : "/taller/ventas_dedit.php?vven_cod="+ven+"&vart_cod="+art+"&vdep_cod="+dep,
                cache   : false,
                beforeSend:function(){
        ...
        function add(ped,art,dep,ven){
        
            $.ajax({
                type    : "GET",
                url     : "/taller/ventas_dadd.php?vped_cod="+ped+"&vart_cod="+art+"&vdep_cod="+dep+"&vven_cod="+ven,
                cache   : false,
                beforeSend:function(){
                    $("#detalles").html('<strong>Cargando...</strong>')
                },
